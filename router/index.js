...
router.use("/book-room-by-use",authMiddleware,  manageBookRoomByUser);  // user auth
router.use("/admin",authMiddleware, authorize('admin'), adminRouter); // admin auth role-based
